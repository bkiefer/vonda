...
\todo{AW: This sounds a little bit like vonda just not supports these functions, even though ''special'' is emphasized}
...
verbal output and gestures with the help of a multimodal generation component, \todo{AW: So there is a multimodal component, doesn't this contradict the statement above which I marked?}
...
\todo{AW: Maybe mention triples vs quadruples?}
...
\todo{AW: Make sure this is up-to-date}
...
\todo{AW: Give just a bit more information about what this is good for}

\subsection{Resolving Namespace Ambiguities}
\todo{AW: Does this really belong here? It's rather an advanced feature, might go to Chapter 4?}
