...
\subsection{Usage of HFC in \vonda} \label{hfc_usage}
...
\todo{Add example of how to query proxy in Java code, and mention that we want to add functionality for easy querying in rudi code}
