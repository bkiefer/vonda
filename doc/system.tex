...
\todo[inline]{AW: test: does Child c; really create the instance? If not, rather put c = new Child; to not suggest this is possible}
...
If, for example, the type of the expression on the right-hand side of a
...
application.
\todo{AW: TODO: go over this, delete what has been mentioned in other chapters, reformulate}
