 ...
 * have to be transformed into fully specified logical forms that can be passed
 * on to, e.g., natural language generation.
 */
public class ProtoLf {
  ...
  /**
   * return the atomic string value under the given edge, if it exists, null
   * otherwise
   *
   * @param edgeName
   * @return the atomic string value under the given edge, if it exists, null
