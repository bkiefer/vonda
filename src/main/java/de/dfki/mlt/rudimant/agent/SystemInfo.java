...
public class SystemInfo implements org.apache.thrift.TBase<SystemInfo, SystemInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SystemInfo> {
  ...
  static {
    schemes.put(StandardScheme.class, new SystemInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SystemInfoTupleSchemeFactory());
  }
  ...
  public SystemInfo setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  private static class SystemInfoStandardSchemeFactory implements SchemeFactory {
    public SystemInfoStandardScheme getScheme() {
      return new SystemInfoStandardScheme();
    }
  }

  private static class SystemInfoStandardScheme extends StandardScheme<SystemInfo> {
  ...
  private static class SystemInfoTupleSchemeFactory implements SchemeFactory {
    public SystemInfoTupleScheme getScheme() {
      return new SystemInfoTupleScheme();
    }
  }

  private static class SystemInfoTupleScheme extends TupleScheme<SystemInfo> {
